...
COMMON+= -DOPENCV
CFLAGS+= -DOPENCV
LDFLAGS+= -LN:/win_shared/opencv/opencv/buildx/install/x64/mingw/lib -LN:/win_shared/opencv/opencv/buildx/install/x64/mingw/lib -LN:/win_shared/opencv/opencv/buildx/3rdparty/lib -lopencv_imgproc249 -lopencv_core249 -lopencv_highgui249 -LC:/OpenCV2.4MinGW/3rdparty/lib -llibjpeg -llibtiff -llibpng -llibjasper -lIlmImf
COMMON+= -IN:/win_shared/opencv/opencv/buildx/install/include
